...
{
       0,    71,    71,    77,    80,    71,    91,    95,   101,   107,
     111,   115,   117,   121,   126,   130,   130,   137,   137,   144,
     144,   156,   157,   161,   163,   167,   173,   174,   178,   180,
     184,   188,   190,   192,   194,   198,   200,   204,   211,   221,
     225,   231,   233,   237,   239,   241,   245,   249,   251,   257,
     259,   261,   263,   265
};
#endif
...
{
  "$end", "error", "$undefined", "PROGRAM", "VAR", "INTEGER", "REAL",
  "BEGIN_", "END", "NUMBER", "ID", "FUNCTION", "PROCEDURE", "IF", "THEN",
  "ELSE", "WHILE", "DO", "OR", "NOT", "ASSIGNOP", "MULOP", "RELOP", "SIGN",
  "PLUS", "MINUS", "MUL", "DIV", "GT", "LT", "GTE", "LTE", "EQ", "NOTEQ",
  "'('", "')'", "';'", "'.'", "','", "':'", "'['", "']'", "$accept",
  "program", "$@1", "$@2", "$@3", "identifier_list", "declarations",
  "type", "standard_type", "subprogram_declarations",
  "subprogram_declaration", "$@4", "subprogram_head", "$@5", "$@6",
...
static const yytype_uint16 yytoknum[] =
{
     ...
     285,   286,   287,   288,    40,    41,    59,    46,    44,    58,
      91,    93
};
# endif
...
{
      38,    -1,    18,     3,   -80,    39,   -80,    15,    19,    52,
     -80,   -80,   -80,    69,    39,    16,     5,    64,    65,    70,
      42,   -80,    60,   -80,   -80,    35,   -80,   -80,    69,   -80,
     -80,    43,   -80,    46,    46,     6,     2,     2,   -80,    73,
      47,   -80,    66,   -80,    48,    70,   -80,    39,    45,    51,
       2,     2,   -80,   -24,     4,     4,     2,   -80,    74,    34,
      68,   -80,    75,   -80,    35,     2,   -80,   -80,    29,    36,
      60,   -80,    25,   -80,    49,     2,   -80,    68,    56,    35,
       4,     2,     4,     4,    35,   -80,   -80,    60,   -80,    39,
      57,   -80,     2,   -80,    26,   -80,    79,    68,    -3,    68,
     -80,   -80,   -80,    31,   -80,   -80,   -80,    35,    60,   -80,
     -80
};
...
{
       0,     0,     0,     0,     1,     0,     6,     0,     0,     0,
       2,     7,     9,    14,     0,     3,     0,     0,     0,     0,
       0,     9,     0,    17,    19,    27,     4,    13,    15,    11,
      12,     0,    10,    22,    22,    37,     0,     0,    32,     0,
      26,    28,     0,    31,     0,     0,     8,     0,     0,     0,
       0,     0,    51,    35,     0,     0,     0,    49,     0,    41,
      43,    47,     0,    25,     0,     0,     5,    16,     0,     0,
       0,    20,     0,    39,     0,     0,    53,    44,     0,     0,
       0,     0,     0,     0,     0,    29,    30,     0,    21,     0,
       0,    38,     0,    36,     0,    52,     0,    46,    42,    45,
      48,    34,    23,     0,    18,    40,    50,     0,     0,    33,
      24
};
...
{
     -80,   -80,   -80,   -80,   -80,   -13,    76,   -79,    28,   -80,
     -80,   -80,   -80,   -80,   -80,    61,   -80,   -12,   -80,   -80,
     -60,   -25,   -80,    21,   -34,    20,   -50,   -48
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,    12,    19,    44,     7,    13,    31,    32,    15,
      20,    45,    21,    33,    34,    48,    69,    38,    39,    40,
      41,    57,    43,    72,    73,    59,    60,    61
};
...
{
      42,    16,    58,    62,    85,    77,    76,    26,   102,     3,
      75,    52,    53,    52,    53,    80,    51,    74,     4,    96,
      82,    54,    78,    54,   101,    55,   -35,    17,    18,   110,
      97,    86,    99,    67,    68,   100,    56,     5,    56,    42,
      50,     1,    25,     9,    22,    35,    51,   109,    36,     6,
       8,    37,    80,     9,    42,    10,    81,    82,   105,    42,
      91,   106,    11,    92,    92,    29,    30,     9,    87,     9,
     108,    88,    89,    14,    23,    24,   103,    25,    27,    46,
      47,    63,    42,    64,    70,    66,    65,    71,    79,    83,
      93,    95,    84,   104,   107,    49,    94,    28,    90,     0,
       0,    98
};

static const yytype_int8 yycheck[] =
{
      25,    14,    36,    37,    64,    55,    54,    19,    87,    10,
      34,     9,    10,     9,    10,    18,    40,    51,     0,    79,
      23,    19,    56,    19,    84,    23,    20,    11,    12,   108,
      80,    65,    82,    45,    47,    83,    34,    34,    34,    64,
      34,     3,     7,    38,    39,    10,    40,   107,    13,    10,
      35,    16,    18,    38,    79,    36,    22,    23,    92,    84,
      35,    35,    10,    38,    38,     5,     6,    38,    39,    38,
      39,    35,    36,     4,    10,    10,    89,     7,    36,    36,
      34,     8,   107,    36,    39,    37,    20,    36,    14,    21,
      41,    35,    17,    36,    15,    34,    75,    21,    70,    -1,
      -1,    81
};
...
{
       0,     3,    43,    10,     0,    34,    10,    47,    35,    38,
      36,    10,    44,    48,     4,    51,    47,    11,    12,    45,
      52,    54,    39,    10,    10,     7,    59,    36,    48,     5,
       6,    49,    50,    55,    56,    10,    13,    16,    59,    60,
      61,    62,    63,    64,    46,    53,    36,    34,    57,    57,
      34,    40,     9,    10,    19,    23,    34,    63,    66,    67,
      68,    69,    66,     8,    36,    20,    37,    59,    47,    58,
      39,    36,    65,    66,    66,    34,    69,    68,    66,    14,
      18,    22,    23,    21,    17,    62,    66,    39,    35,    36,
      50,    35,    38,    41,    65,    35,    62,    68,    67,    68,
      69,    62,    49,    47,    36,    66,    35,    15,    39,    62,
      49
};
...
static const yytype_uint8 yyr1[] =
{
      ...
      49,    50,    50,    51,    51,    53,    52,    55,    54,    56,
      54,    57,    57,    58,    58,    59,    60,    60,    61,    61,
...
#line 144 "parser.y" /* yacc.c:1646  */
    {
        Symbol& procedure = symTable.get((yyvsp[0]));
